...
protected:
    const ItemStackRequestAction& mRequestAction;

public:
    constexpr explicit HandleRequestActionBeforeEvent(Player& player,const ItemStackRequestAction& requestAction)
    : Cancellable(player),
...
protected:
    class ItemStackRequestAction const& mRequestAction;
